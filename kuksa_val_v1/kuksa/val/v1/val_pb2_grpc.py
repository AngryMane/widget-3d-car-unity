...
from . import val_pb2 as kuksa_dot_val_dot_v1_dot_val__pb2
...
class VAL(object):
    ...
    def StreamedUpdate(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/kuksa.val.v1.VAL/StreamedUpdate',
